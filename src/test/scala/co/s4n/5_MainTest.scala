...
class CaseClassMergeTest extends FunSuite {

  test("Case class merge") {
...
object CaseClassMerge {
  ...
  implicit def mkCCMerge[T, U, RT <: HList, RU <: HList](implicit tgen: LabelledGeneric.Aux[T, RT],
